...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    privatePrompts: {
      ...
      prompt2:
        "I connect best with people who are passionate about their hobbies.",
    },
...
export const MOCK_EVENTS: Event[] = [
  ...
  },
  {
    ...
    communityId: "comm-2",
    description:
      "Let's go for a casual 5k run along the beautiful West Kowloon waterfront. A perfect way to de-stress and stay active. We'll end with some stretching and social time.",
  ...
  },
  {
    ...
    communityId: "comm-3",
    description:
      "Join the Movie Buffs for a special screening of Christopher Nolan's masterpiece, Inception. Popcorn will be provided! We'll have a short discussion after the film.",
  ...
  },
  {
    ...
    communityId: "comm-4",
    description:
      "Have a startup idea? Come pitch it to fellow entrepreneurs and get valuable feedback. Or just come to listen and get inspired!",
...
export const MOCK_POSTS: Post[] = [
  ...
  },
  {
    ...
    timestamp: "5h ago",
    content:
      "Just finished a new climbing route at the gym! Feeling accomplished. Anyone else hit a PR recently?",
  },
  {
    id: "post-3",
    type: "event",
  ...
  },
  {
    ...
    timestamp: "2d ago",
    content:
      "Just rewatched Blade Runner 2049. What a masterpiece. What are your thoughts on it?",
  },
];
